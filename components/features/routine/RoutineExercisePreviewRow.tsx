...
// a camera button into a prefilled Live Review session for pose-trackable
// exercises specifically.
export function RoutineExercisePreviewRow({ item, isCompleted, onToggleComplete, onStartLiveReview }: RoutineExercisePreviewRowProps) {
